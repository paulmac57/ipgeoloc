...
if __name__ == "__main__":
    ...
    for measurement in data:
        print (measurement)
        m=1
        measurement['target_id'] = data[measurement]['probe_id']
        measurement['target_ip'] = data[measurement]['target_ip']
        measurement['target_lat'] = data[measurement]['target_lat']
        measurement['target_lon'] = data[measurement]['target_lon']
        measurement['target_address'] = data[measurement]['target_address']
        measurement['target_isanchor'] = data[measurement]['target_isanchor']  

        print(measurement)
        for probe in data[measurement]:
            print("Probe is ", probe)
            
            if probe not in ('target_ip','target_address', 'target_isanchor','target_lat', 'target_lon'):
                hops = 0
                total_rtt = 0
